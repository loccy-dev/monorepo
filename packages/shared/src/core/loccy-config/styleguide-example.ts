// The one styleguide example: a fresh `loccy.yaml` ships it commented out, the docs render it as
// their reference example. Every field and every value shape appears exactly once.

export const STYLEGUIDE_EXAMPLE_YAML = `styleguide:
  product: |
